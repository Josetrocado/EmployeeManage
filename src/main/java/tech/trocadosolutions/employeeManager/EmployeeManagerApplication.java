package tech.trocadosolutions.employeeManager;
...
//    corsConfiguration.setAllowedOrigins(Arrays.asList("htttp://localhost:4200"));
  ...
  public WebMvcConfigurer corsConfigurer() {
    return new WebMvcConfigurerAdapter() {
      ...
      public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").allowedMethods("GET", "POST", "OPTIONAL", "DELETE", "PATCH").allowedOrigins("*")
          .allowedHeaders("*");
      }
    };
  }
